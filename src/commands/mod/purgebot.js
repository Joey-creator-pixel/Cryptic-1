  ...
  constructor(client) {
    super(client, {
      ...
      description: oneLine`
        ...
        and deletes all Cryptics commands and messages from Cryptic.
  ...
  async run(message, args) {
    ...
    if (messages.size === 0) { // No messages found
      ...
      message.channel.send(
        new MessageEmbed()
          .setTitle('Purgebot')
          .setDescription(`Unable to find any bot messages or commands. This message will be deleted after \`10 seconds\`.`)
