...
module.exports = class FeedbackCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: 'Sends a message to the Cryptic Support Server\'s feedback channel.',
      type: client.types.MISC,
      examples: ['feedback We love Cryptic!']
    });
  }
  run(message, args) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(oneLine`
        ...
        Please join the [Cryptic Support Server](https://discord.gg/DFZv2Zh) to further discuss your feedback.
      `) 
