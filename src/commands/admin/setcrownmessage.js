...
module.exports = class SetCrownMessageCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: oneLine`
        Sets the message Cryptic will say during the crown role rotation.
        You may use \`c!member\` to substitute for a user mention ,
        \`c!username\` to substitute for someone's username,
        \`c!tag\` to substitute for someone's full Discord tag (username + discriminator),
        \`c!role\` to substitute for the \`crown role\`,
        and \`c!points\` to substitute for the current points of the winner.
