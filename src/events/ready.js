module.exports = async (client) => {
  ...
  for (const guild of leftGuilds) {
    ...
    client.logger.info(`Cryptic has left ${guild.guild_name}`);
  }

  client.logger.info('Cryptic is now online');
  client.logger.info(`Cryptic is running on ${client.guilds.cache.size} server(s)`);
};
