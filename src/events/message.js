  ...
  if (prefixRegex.test(message.content)) {
    ...
    if (command && !disabledCommands.includes(command.name)) {
      ...
      const embed = new MessageEmbed()
        .setTitle('Hi, I\'m Cryptic. Need help?')
        ...
        .addField('Invite Me', oneLine`
          ...
          [here](https://discordapp.com/oauth2/authorize?client_id=612134650114080818&scope=bot&permissions=403008599)!
        `)
        .addField('Support', oneLine`
          If you have questions, suggestions, or found a bug, please join the 
          [Cryptic Support Server](https://discord.gg/DFZv2Zh)!
        `)
        .setFooter('DM ++Roman++#4319 to speak directly with the developer!')
